...
var (
	...
	PersistencePostgresMaxConnections             = ffc("persistence.postgres.maxConns")
	PersistencePostgresMaxConnIdleTime            = ffc("persistence.postgres.maxConnIdleTime")
	PersistencePostgresMaxConnLifetime            = ffc("persistence.postgres.maxConnLifetime")
	PersistencePostgresMaxIdleConns               = ffc("persistence.postgres.maxIdleConns")
...
func setDefaults() {
	...
	viper.SetDefault(string(PersistencePostgresMaxConnIdleTime), "1m")
