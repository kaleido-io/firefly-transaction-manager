...
var (
	...
	ConfigDatabasePostgresHistogramsMaxChartRows = ffc("config.persistence.postgres.histograms.maxChartRows", "The maximum rows to fetch for each histogram bucket", i18n.IntType)
